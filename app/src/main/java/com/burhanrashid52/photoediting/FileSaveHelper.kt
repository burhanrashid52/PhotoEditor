...
class FileSaveHelper(private val mContentResolver: ContentResolver) : LifecycleObserver {
    ...
    private fun getEditedImageUri(fileNameToSave: String, newImageDetails: ContentValues, imageCollection: Uri): Uri {
    ...
    private class FileMeta(var isCreated: Boolean, var filePath: String?,
    ...
    private fun updateResult(result: Boolean, filePath: String?, error: String?, uri: Uri?, newImageDetails: ContentValues?) {
