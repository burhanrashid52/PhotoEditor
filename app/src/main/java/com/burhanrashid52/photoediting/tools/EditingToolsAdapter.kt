...
class EditingToolsAdapter(private val mOnItemSelected: OnItemSelected) : RecyclerView.Adapter<EditingToolsAdapter.ViewHolder>() {
    ...
    internal inner class ToolModel(val mToolName: String, val mToolIcon: Int, val mToolType: ToolType)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener { v: View? -> mOnItemSelected.onToolSelected(mToolList[layoutPosition].mToolType) }
        }
    }
