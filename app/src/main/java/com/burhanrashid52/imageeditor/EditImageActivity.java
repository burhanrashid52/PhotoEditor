...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    private void saveImage() {
        ...
        if (requestPermission( Manifest.permission.WRITE_EXTERNAL_STORAGE )) {
            showLoading( "Saving..." );
            File file = new File( String.format( Locale.ENGLISH, "%s%s%d.png",
    ...
    @SuppressLint("MissingPermission")
    private void saveTopImage() {

        if (requestPermission( Manifest.permission.WRITE_EXTERNAL_STORAGE )) {
            showLoading( "Saving..." );
            File file = new File( Environment.getExternalStoragePublicDirectory( DIRECTORY_PICTURES )
                                          + File.separator + ""
