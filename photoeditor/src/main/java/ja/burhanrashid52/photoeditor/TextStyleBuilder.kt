...
open class TextStyleBuilder {
    ...
    protected open fun applyTextBorder(textView: TextView, textBorder: TextBorder) {
        ...
        gd.cornerRadius = textBorder.getCorner()
...
//        textView.setPaintFlags(textView.getPaintFlags()|flag);
     ...
     */
    protected enum class TextStyle(private val property: String) {
        SIZE("TextSize"), COLOR("TextColor"), GRAVITY("Gravity"), FONT_FAMILY("FontFamily"), BACKGROUND("Background"), TEXT_APPEARANCE("TextAppearance"), TEXT_STYLE("TextStyle"), TEXT_FLAG("TextFlag"), SHADOW("Shadow"), BORDER("Border");
