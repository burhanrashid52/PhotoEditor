 ...
 * @since 18/01/2017
 */
internal class PhotoEditorImpl @SuppressLint("ClickableViewAccessibility") internal constructor(builder: PhotoEditor.Builder) : PhotoEditor {
    ...
    override fun addText(text: String?, styleBuilder: TextStyleBuilder?) {
        ...
        val textGraphic = Text(parentView, multiTouchListener, viewState, mDefaultTextTypeface, mGraphicManager)
    ...
    override fun addEmoji(emojiTypeface: Typeface?, emojiName: String?) {
        drawingView!!.enableDrawing(false)
        val multiTouchListener = getMultiTouchListener(true)
        val emoji = Emoji(parentView, multiTouchListener, viewState, mGraphicManager, mDefaultEmojiTypeface)
    ...
    override fun saveAsFile(imagePath: String,
    ...
    @SuppressLint("StaticFieldLeak")
    override fun saveAsBitmap(saveSettings: SaveSettings,
