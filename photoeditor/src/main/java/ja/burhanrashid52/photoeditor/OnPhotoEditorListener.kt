...
interface OnPhotoEditorListener {
     ...
     *
     * @param rootView           parent view on which the actual graphics are drawn
     * @param viewType           enum which define type of view is added
     * @param numberOfAddedViews number of views currently added
     * @see ViewType
     */
    fun onAddViewListener(rootView: View?, viewType: ViewType?, numberOfAddedViews: Int)
     ...
     * @param numberOfAddedViews number of views currently added
     */
    fun onRemoveViewListener(rootView: View?, viewType: ViewType?, numberOfAddedViews: Int)
     ...
     * @param viewType enum which define type of view is added
     */
    fun onStartViewChangeListener(rootView: View?, viewType: ViewType?)
     ...
     * @param viewType enum which define type of view is added
     */
    fun onStopViewChangeListener(rootView: View?, viewType: ViewType?)
